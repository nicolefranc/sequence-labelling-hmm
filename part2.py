...
class part2:
        ...
        for layer in range(len(sentence)):
            ...
            for state in range(len(self.states_dict)-2):
                ...
                if layer == 0:
                    ...
                    best_path_so_far = viterbi_lookup[layer -
                                                      1][state][0]+[state, self.states_dict["STOP"]]
    ...
    def viterbi(self, emission_class):
        ...
        for i in range(len(self.x_val)):
            viterbi_lookup = self.viterbi_per_sentence(
            ...
            max_pi, index = self.argmax(final_pi)
...
if __name__ == "__main__":
    ...
    export_predictions_from_list(
        part2.get_x_val(), predictions=states, lang=LANG, part=2)
